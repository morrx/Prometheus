...
void Render::SetupFonts()
{
	...
	g_Surface->SetFontGlyphSet(font.ESP, "Verdana", 11, 750, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Defuse, "Tahoma", 15, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Watermark, "Verdana", 16, 700, 0, 0, FONTFLAG_OUTLINE | FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.DroppedGuns, "Dotum", 12, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	g_Surface->SetFontGlyphSet(font.Guns, "Code Bold", 14, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.NameFont, "Verdana", 16, 800, 0, 0, FONTFLAG_DROPSHADOW);
