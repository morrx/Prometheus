...
{
	if (!g_Options.LegitBot.Legitbotrun)
		return;
...
bool legitbot::get_hitbox(C_BaseEntity *local, C_BaseEntity *entity, Vector &destination)
{
	...
	{
		kek = { (int)CSGOHitboxID::Head, (int)CSGOHitboxID::Chest,(int)CSGOHitboxID::Neck, (int)CSGOHitboxID::NeckLower, (int)CSGOHitboxID::Stomach };
	}
